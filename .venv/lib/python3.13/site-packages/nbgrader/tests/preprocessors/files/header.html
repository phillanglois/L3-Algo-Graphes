...
<link rel="preload" as="script" href="../../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=55c26ed414f5f8a31ebb" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.13/site-packages/nbgrader/tests/preprocessors/files/header';</script>
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://mybinder.org/v2/gh/phillanglois/L3-AlgoGraphes/main?urlpath=tree/release/.venv/lib/python3.13/site-packages/nbgrader/tests/preprocessors/files/header.ipynb" target="_blank"
...
<a href="https://github.com/phillanglois/L3-AlgoGraphes/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.13/site-packages/nbgrader/tests/preprocessors/files/header.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../../_sources/.venv/lib/python3.13/site-packages/nbgrader/tests/preprocessors/files/header.ipynb" target="_blank"
...
<div class="highlight-ipython3 notranslate"><div class="highlight"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="s2">"I am a header! with special characters such as å ä and ö"</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="cell_output docutils container">
<div class="output stream highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>I am a header! with special characters such as å ä and ö
</pre></div>
</div>
</div>
</div>
